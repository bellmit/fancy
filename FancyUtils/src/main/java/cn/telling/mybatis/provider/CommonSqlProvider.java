package cn.telling.mybatis.provider;
...
import cn.telling.constant.Constant;
import cn.telling.mybatis.EntityHelper;
...
public class CommonSqlProvider extends BaseProvider{
	...
	public String findEntityListByDataScope(final Map<String, Object> params){
		...
		return new SQL(){{
            ...
            cn.telling.mybatis.EntityHelper.EntityTable entityTable = EntityHelper.getEntityTable(entityClass);
            SELECT(cn.telling.mybatis.EntityHelper.getAllColumns(entityClass));
