...
public class TreeNode {
    ...
    private BigDecimal id;          //要显示的子节点的ID
	...
	private BigDecimal parentId;    //父节点的ID
    ...
    public TreeNode(BigDecimal id, String text, String iconCls,String url, BigDecimal parentId,
