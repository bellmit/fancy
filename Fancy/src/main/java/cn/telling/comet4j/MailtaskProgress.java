...
public class MailtaskProgress implements ServletContextListener {
    ...
    private static String[] PATH = { "classpath:applicationContext-test.xml" };

	public MailtaskProgress() {
	MailtaskProgress.applicationContext = new ClassPathXmlApplicationContext(PATH);
	}
...
//	private MailtaskDao mailtaskDao;
	...
	public AbstractApplicationContext getAbstractApplicationContext() {
		return MailtaskProgress.applicationContext;
	}
