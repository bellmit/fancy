...
public class BaseUtil {
	...
	public static String getStaticFilePathForUpload(HttpServletRequest request,
		...
		if ("localhost".equals(serverName) || "127.0.0.1".equals(serverName)) {
			...
			StringBuffer temp = new StringBuffer("/mnt/b2b/").append(yourPath);
			uploadPath = temp.toString();
		}
		return uploadPath;
	}
	...
	public static String showStaticFilesPath(HttpServletRequest request) {
		...
		} else if ("192.168.102.50".equals(serverName) || "218.22.225.250".equals(serverName)|| "220.181.188.246".equals(serverName)|| "192.168.100.5".equals(serverName)|| "220.181.188.229".equals(serverName)|| "192.168.100.202".equals(serverName)|| "192.168.100.8".equals(serverName)|| "220.181.188.245".equals(serverName)||"192.168.100.203".equals(serverName)) {// 说明是测试服务器
			showImages = "/sfiles/";
		} else {// 默认是正式系统
			showImages = "http://image.tianlian.com/";
		}
		return showImages;
	}
