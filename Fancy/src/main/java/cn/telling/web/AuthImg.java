...
public class AuthImg extends HttpServlet {
	 ...
	 * @since JDK 1.6
	 */
	private static final long serialVersionUID = 5754472273511575564L;
	...
	public void service(HttpServletRequest request, HttpServletResponse response) {
		...
		BufferedImage image = new BufferedImage(100, IMG_HEIGTH, BufferedImage.TYPE_INT_RGB);
		Graphics g = image.getGraphics();
		Random random = new Random();
		g.setColor(getRandColor(200, 250));
		// 填充背景色
		g.fillRect(1, 1, 100 - 1, IMG_HEIGTH - 1);
		// 为图形验证码绘制边框
		g.setColor(new Color(102, 102, 102));
		g.drawRect(0, 0, 100 - 1, IMG_HEIGTH - 1);
