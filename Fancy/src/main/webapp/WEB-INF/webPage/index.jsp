  ...
  <body class="easyui-layout">
	<div data-options="region:'north',collapsed:false"
		...
		<div id="mm3" class="menu-content"
			style="width: 100px; background: #f0f0f0; padding: 10px; text-align: left">

			<p style="font-size: 14px; color: #444;">V2.0</p>
		</div>
	</div>
	...
	<div data-options="region:'east',split:true,collapsed:true,title:'右侧菜单'" style="width: 100px; padding: 10px;">测试内容</div>
	<div data-options="region:'south',split:true,collapsed:true" style="height: 50px; background: #A9FACD; padding: 10px;">Fancy 版权所有 翻版必究</div>
