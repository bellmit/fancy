...
<title>用户IP分布</title>
<link href="<%=basePath%>plug/bootstrap/css/bootstrap.min.css" rel="stylesheet">
<link href="<%=basePath%>plug/bootstrap/css/bootstrap-treeview.min.css" rel="stylesheet">
<style type="text/css">
...
<script type="text/javascript" src="<%=basePath%>plug/bootstrap/js/bootstrap.min.js"></script>
<script type="text/javascript" src="<%=basePath%>plug/bootstrap/js/bootstrap-treeview.min.js"></script>
...
<script type="text/javascript">
    ...
    <!-- Highcharts -->
    <script src="<%=basePath%>plug/Highcharts/highmaps.js"></script>
    <script src="<%=basePath%>plug/Highcharts/modules/data.js"></script>
    <script src="<%=basePath%>plug/Highcharts/modules/drilldown.js"></script>
    <script src="<%=basePath%>plug/Highcharts/mapdata/cn-all-sar-taiwan-pretty.js"></script>
</html>