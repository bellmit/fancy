...
CREATE TABLE `menu` (
  ...
  `sortfiled` tinyint(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Records of menu
-- ----------------------------
INSERT INTO `menu` VALUES ('1', '用户管理', '0', '导航菜单', '/#', '1', '1', '2016-01-02 11:59:33', '0');
INSERT INTO `menu` VALUES ('2', '角色管理', '0', '导航菜单', '/rolesys.html', '1', '1', '2015-12-18 16:59:31', '1');
...
INSERT INTO `menu` VALUES ('8', '菜单管理', '7', '菜单管理', '/menu.html', '1', '1', '2013-12-12 10:51:54', '0');
INSERT INTO `menu` VALUES ('9', '用户列表', '1', '用户列表', '/user/list.html', '1', '1', '2016-01-29 17:29:55', '1');
INSERT INTO `menu` VALUES ('10', null, null, null, null, null, null, null, null);
